...
fn callback_get_validation(
  query_params: models::CallbackGetQueryParams,
) -> std::result::Result<(
  models::CallbackGetQueryParams,
), ValidationErrors>
{
...
#[tracing::instrument(skip_all)]
async fn callback_get<I, A>(
  method: Method,
  host: Host,
  cookies: CookieJar,
  Query(query_params): Query<models::CallbackGetQueryParams>,
    ...
    A: apis::default::Default,
{
  ...
  let result = api_impl.as_ref().callback_get(
      method,
      host,
      cookies,
        query_params,
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::default::CallbackGetResponse::Status302_RedirectsTheUserToTheApplicationAfterSuccessfulAuthentication
                                                => {
                                                  let mut response = response.status(302);
                                                  response.body(Body::empty())
                                                },
                                                apis::default::CallbackGetResponse::Status400_BadRequest
                                                => {
                                                  let mut response = response.status(400);
                                                  response.body(Body::empty())
                                                },
                                                apis::default::CallbackGetResponse::Status500_ServerErrorDuringTokenExchange
                                                => {
